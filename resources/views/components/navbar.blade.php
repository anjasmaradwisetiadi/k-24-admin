...
<nav class="navbar navbar-color navbar-expand-lg text-white py-2">
    <div class="container">
      <div class="navbar-nav mr-auto">
        <a class="navbar-brand" href="/">K-24 Adminr</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav navbar-list d-flex justify-content-center">
            <a class="nav-link text-white align-self-center ml-2 {{isset($active) ? $active === 'administator' ? 'active': '' : ''}}"  href="/administator">Administator </a>
            <a class="nav-link text-white align-self-center ml-2 {{isset($active) ? $active === 'member' ? 'active': '': ''}}"  href="/member">Member</a>
